...
/**
 * 作成フォームの基本情報カード。商品名（Input）/ 説明（Textarea）/ カバー画像（破線ドロップゾーン）。
 * 編集画面の BasicInfoCard と同型だが、新規スキーマ（ProductCreateFormValues）に紐づく。
 */
export function CreateBasicInfoCard({ control, onUploadCover }: Props) {
  return (
